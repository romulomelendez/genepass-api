...
const ActionButtons: React.FC = () => {
    ...
    const { pwdData: { length: passwordLength } , handlePwdUserPreferences: updatePwdLength } = usePwd()
        ...
        <section className="flex flex-col sm:flex-row p-7 gap-8 h-auto w-auto justify-center bg-slate-900 rounded-2xl">
            <div className="flex flex-col gap-3 justify-center items-center">
                ...
                <input
                  ...
                  onChange={e => updatePwdLength({ name: "length", content: e.target.value })}
            ...
            <div className="flex flex-col gap-2 justify-center ml-9">
                ...
                <div className="flex gap-3 items-center">
                    <Checkbox
                      functionName="capitalLetters"
                      name="Capital Letters"
                    />
                </div>
                <div className="flex gap-3 items-center">
                    <Checkbox
                      functionName="smallLetters"
                      name="Small Letters"
                    />
                </div>
            </div>
